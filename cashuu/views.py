from api.bid_api.serializers import EMICalculationSerializer, EMICalculationForEDISerializer
...
def LoanView(request, slug):
    ...
    serializer = EMICalculationForEDISerializer(data=payload, context={'user_id':request.user.id})
